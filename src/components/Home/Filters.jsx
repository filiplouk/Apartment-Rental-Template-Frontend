    ...
    <div className="filters row">
       <div className="col-12 filters-box">
         ...
         <div className="filters-box__content">
            ...
            <input className="form-control form-control-lg mt-3 mb-3" type="date" id="start" name="trip-start" value="2023-01-22" min="2023-01-22" max="2023-12-31"></input>
            <label for="stop">Move Out</label>
            <input className="form-control form-control-lg"type="date" id="stop" name="trip-stop" value="2023-01-22" min="2023-01-22" max="2023-12-31"></input>
         </div>
